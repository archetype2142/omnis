module Spree
  module UserMethods
    ...
    included do
      ...
      self.whitelisted_ransackable_attributes = %w[id email client_type]

      scope :with_price_book, -> { where(id: Spree::PriceBook.pluck(:user_id).uniq) }
